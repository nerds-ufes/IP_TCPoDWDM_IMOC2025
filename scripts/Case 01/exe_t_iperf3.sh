...
for queue in 100 95 90 85 80 75 70 65 60 55 50 45 40 35 30 25 20 15 10 5;
do
	diretorio=Data
	BASEDIR=$(dirname $0)
	...
	sudo python3 tcp_cc_mn_iperf4.py -a bbr bbr bbr2 bbr2 cubic cubic bic bic reno reno -d 10 -l 0 -q $queue
