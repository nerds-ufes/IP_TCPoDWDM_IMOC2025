...
def tcp_test(algs, delays, p_loss, queue):
    ...
    # for i in range(len(alg)):
        # data_fairness = parse_iperf_data(alg[i], delay, host_addrs, 'h{}'.format(10+i), 'h{}'.format(20+i))
        # draw_fairness_plot(data_fairness['h{}'.format(10+i)]['time'], data_fairness['h{}'.format(10+i)]['Mbps'], alg[i], delay, 'h{}'.format(10+i), 'h{}'.format(20+i))

	
    # data_fairness = parse_iperf_data(alg[0], delay, host_addrs, 'h10', 'h20')
    # draw_fairness_plot(data_fairness['h10']['time'], data_fairness['h10']['Mbps'], 'cubic', delay)
